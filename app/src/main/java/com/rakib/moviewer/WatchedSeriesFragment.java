...
public class WatchedSeriesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.watched_series_recycler);

        imageView = view.findViewById(R.id.no_series_image);
        relativeLayout = view.findViewById(R.id.no_series);
        progressBar = view.findViewById(R.id.watched_series_progress_bar);
...
//        recyclerView.setLayoutAnimation(animation);
    ...
    private void loadWatchedSeries() {
        Log.d("ttaagg","came here");
        final Query query = db.collection("Watched Series").orderBy("title").whereEqualTo("userId", FirebaseAuth.getInstance().getCurrentUser().getUid());
        ...
        adapter = new FirestoreRecyclerAdapter<Series, MySeriesViewHolder>(response) {
            ...
            public void onDataChanged() {
                ...
                SharedPref.write(firebaseUserId + "watched_series",number);
                super.onDataChanged();
